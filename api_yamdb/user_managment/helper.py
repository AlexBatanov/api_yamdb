...
def get_users(data):
    ...
    user_filter_name = User.objects.filter(username=data.get('username')).first()
    user_filter_email = User.objects.filter(email=data.get('email')).first()
